...
The gun control issue has always been debated for a long time, probably ever since they were invented.However, the project isn't about to argue about the gun control issue or Second Amendment, the purpose of the project is more about to gain some statistic insights on mass shootings and have a better understanding of relationships between characteristics of the shooters and the incidents by performing spatial and statistical analysis on mass shooting dataset from Kaggle.
